                                ...
                                <div class="single_widget_form text-left">
                                    <form action="#" id="formid">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="name" placeholder="first name" required=""></input>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Subject"></input>np
                                        </div> 
                                        ...
                                        <input type="submit" value="click here" class="btn btn-primary"></input>
                                    </form>	
                                </div>
                            </div>
                        </div>
